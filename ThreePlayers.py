...
def ThreePlayers(players_turns, turn_num, overall_turns, win = False, with_computer = False):
    pygame.mixer.init()
    ...
    while game_on:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if clicked_sprites:
                    ...
                    if matrix[clicked_token[0], clicked_token[1]] == player_index:
                        ...
                        move_sound.play()
                        animation()
                        if player_index == 3 and not winner() and with_computer:  # Check if it's the computer's turn
                            ...
                            if computer_moves:
                                ...
                                print(selected_move[0], selected_move[1], selected_move)
                                print(move)
        ...
        def return_main_action():
            ...
            logging.info(json.dumps({"game_state": {"num_players": 3, "players_turns": players_turns,
                                                    "turn_num": turn_num, "overall_turns": overall_turns, "win": win,
        ...
        if turn_num < overall_turns:
            button("move forward", 300, 460, 140, 30, button_color, inner_color,
                   lambda: ThreePlayers(players_turns, turn_num + 1, overall_turns, win, with_computer))
